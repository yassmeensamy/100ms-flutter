      ...
      child: Selector<PreviewStore, HMSException?>(
        ...
        builder: (_, error, __) {
          return Scaffold(
            ...
            ///The preview is rendered directly (no scroll view) so the
            ///join button and action controls are always visible at the
            ///bottom without the user needing to scroll
            body: (previewStore.peer == null)
                ? const Center(child: HMSLoader())
                /**
                                  ...
                                  child: (previewStore.isVideoOn)
                                      ...
                                      : Center(
                                          child: HMSCircularAvatar(
                                            avatarTitleTextColor: Colors.white,
                                            name: nameController.text,
                                            avatarUrl: Constant
                                                .prebuiltOptions?.avatarUrl,
                                            avatarRadius: 56,
                                            avatarTitleFontSize: 48,
                                            avatarTitleTextLineHeight: 48,
                                          ),
                                        ),
                                ),
